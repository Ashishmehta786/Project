...
function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      className="py-12 bg-gray-50 dark:bg-gray-900 border-t border-gray-800 z-0 "
    >
        ...
        <div className="mt-10">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className="absolute w-full h-full top-0 right-[280px] group-hover:-right-[280px] transition-all duration-1000"
                  style={{
                    background:
                ...
                ></div>
                <div
                  className="absolute w-full h-full top-0 left-[280px] group-hover:-left-[280px] transition-all duration-1000"
                  style={{
                    background:
                      "radial-gradient(circle,  rgba(96, 165, 250, 0.2) 0%, transparent 70%)",
                  }}
