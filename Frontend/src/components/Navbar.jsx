...
function Navbar() {
  ...
  return (
    <nav className="border-b border-gray-800 dark:border-gray-700 dark:text-white text-gray-800 bg-white top-0 sticky z-20  dark:bg-gray-900 dark:bg-opacity-[90%] backdrop-blur-md ">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 ">
          ...
          <div className="hidden sm:flex sm:space-x-8 h-full">
            ...
            <a
              href="#how-it-works"
              className="border-transparent dark:text-gray-300 hover:border-white dark:hover:text-white inline-flex items-center rounded px-1 pt-1 border-b-[3.9px] text-sm font-medium transition-all duration-300 text-gray-700 hover:text-gray-600 hover:border-gray-700"
            >
              How It Works
            </a>
            <a
